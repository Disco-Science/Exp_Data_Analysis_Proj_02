...
png(filename = "~/Desktop/plot04.png", width=1800,height=1200,res=144)
...
mtext(expression("US total "*PM[2.5]*" coal emission increases when comparing 1999 recording to subsequent recordings up to 2008"), outer = TRUE, cex = 1.2, line = -1)
